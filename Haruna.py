...
<==> Ziad say = Mengikuti Apa Yang DiKatakan
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to, "Senpai Jangan Sider :v,Aku Sleding Nanti"),
                    try:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						if matched_list == []:
							kk.sendText(msg.to,"Maaf ya Senpai")
							kc.sendText(msg.to,"Maaf ya Senpai")
							return
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						ki.sendText(msg.to,"Maaf ya Senpai")
...
#-----------------------------------------------
            elif "Ziad say " in msg.text:
					bctxt = msg.text.replace("Ziad say ","")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By https://line.me/ti/p/~anaichiro")
